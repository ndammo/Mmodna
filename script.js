...
async function initTelegramApp() {
    ...
    // ПРИНУДИТЕЛЬНО ОБНОВЛЯЕМ ПРОФИЛЬ (ВАЖНО ДЛЯ СИНХРОНИЗАЦИИ)
    ...
    if (profileRes && profileRes.success) {
        ...
        console.log('🔄 Профиль обновлён, инвентарь:', state.inventory.length);
    } else {
        console.warn('⚠️ Не удалось загрузить профиль после логина');
    }
